        ...
        var getNumberSlidesShowing = function() {
            ...
            if (slider.settings.mode == 'horizontal' && slider.settings.slideWidth > 0) {
                if (slider.viewport.width() < slider.minThreshold) {
                    ...
                    slidesShowing = Math.round((slider.viewport.width() + slider.settings.slideMargin) / childWidth);
                    // console.log((slider.viewport.width() + slider.settings.slideMargin) / childWidth);
        ...
        var getPagerQty = function() {
            ...
            if (slider.settings.moveSlides > 0) {
                if (slider.settings.infiniteLoop) {
                    ...
                    var breakPoint = 0;
                    var counter = 0;
                    // console.log(breakPoint , slider.children.length);
                    while (breakPoint < slider.children.length) {
                        // console.log(slider.settings.moveSlides , getNumberSlidesShowing());
                        ++pagerQty;
