    ...
    $.fn.bxSlider = function(options) {
        ...
        var setSlidePosition = function() {
            if (slider.children.length > slider.settings.maxSlides && slider.active.last && !slider.settings.infiniteLoop) {
                ...
                console.log(slider.active.index , getMoveBy(),slider.children.eq(slider.active.index * getMoveBy()))
        ...
        var setPositionProperty = function(value, type, duration, params) {
            if (slider.usingCSS) {
                ...
                slider.settings.fullPage && el.css('height','100%');
                if (type == 'slide') {
        ...
        var appendPager = function() {
            ...
            // slider.pagerEl.on('click', 'div', clickPagerBind);
        }
        ...
        var clickPagerBind = function(e) {
            ...
            // if (pagerLink.find('a').attr('data-slide-index') !== undefined) {
            //     var pagerIndex = parseInt(pagerLink.find('a').attr('data-slide-index'));
